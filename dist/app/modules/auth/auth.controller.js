...
const authSignUp = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.authSignUp(userData);
...
const authLogin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userData = req.body;
    const _a = yield auth_service_1.AuthService.authLogin(userData), { refreshToken } = _a, result = __rest(_a, ["refreshToken"]);
    const cookieOptions = {
        httpOnly: true,
